    ...
    <Page size={"A4"} style={stylePdf.root} wrap>
      ...
      <View style={{ display: "flex", flexDirection: "row", gap: 2 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            <Text>
              Bertindak dalam hal ini berdasarkan Perjanjian Kerjasama tentang
              pemberian kredit kepada pensiunan dalam bentuk penerusan
              (Channeling) {data.Bank.sk_akad}, yang selanjutnya disebut{" "}
      ...
      <View style={{ width: 490, lineHeight: 1.2 }}>
        ...
        <View>
          <Text>
            BANK dengan ini menyetujui memberikan suatu kredit kepada DEBITUR
            dan DEBITUR menyetujui untuk menerima fasilitas kredit yang disebut
            Kredit Channeling dengan Plafond Kredit sebesar
        ...
        >
          ...
          <Text style={{ width: 100, fontWeight: "bold" }}>Total Angsuran</Text>
          <Text style={{ width: 20 }}>:</Text>
          <View style={{ display: "flex", gap: 5, flexDirection: "row" }}>
            <Text style={{ width: 50 }}>Rp.</Text>
            <Text style={{ fontWeight: "bold" }}>
        ...
        >
          ...
          <View style={{ fontWeight: "bold" }}>
            <Text>
              {moment(data.tanggal_cetak_akad).add(1, "M").format("DD-MM-YYYY")}
            </Text>
          </View>
        </View>
        <View
        ...
        >
          ...
          <Text>
            Untuk pembebanan angsuran,bunga, provisi, biaya-biaya, denda dan
            segala biaya lainnya yang terhutang berkenaan dengan pemberian
        ...
        >
          ...
          <View>
            <Text>
              DEBITUR berjanji dan dengan ini mengikat diri untuk menanggung
              seluruh biaya yang diperlukan berkenaan dengan pelaksanaan Akad
              ini sepanjang hal ini diberitahukan BANK kepada DEBITUR sebelum
              ditandatangani Akad ini dan DEBITUR menyatakan persetujuannya.
            ...
            >
              <View style={{ display: "flex", flexDirection: "row", gap: 10 }}>
                ...
                <Text>
                  Asli{" "}
                  <Text style={{ fontWeight: "bold" }}>
                    Surat Keputusan (SK) Pensiun : Nomor {data.nomor_sk_pensiun}
                  </Text>{" "}
                  tertanggal :{" "}
                  <Text style={{ fontWeight: "bold" }}>
        ...
        >
          ...
          <View>
            <Text>
              DEBITUR memberi kuasa kepada BANK untuk melakukan tindakan dan
