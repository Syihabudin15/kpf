...
export default function CetakPenyerahanJaminan() {
  ...
  const getData = async () => {
    setLoading(true);
    const res = await fetch(`/api/pemberkasan/cetak-jaminan?page=${page}`);
  ...
  const handleCetak = async () => {
    ...
    setLoading(true);
    const res = await fetch("/api/pemberkasan/cetak-jaminan", {
      method: "POST",
