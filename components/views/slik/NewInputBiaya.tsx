...
export default function NewInputBiaya({
  ...
  useEffect(() => {
    ...
    const reffFee = inputDapem.plafond * (tambahan.refferal_fee / 100);
    const biayaAwal =
      admin +
      asuransi +
      (tempTatalaksana || 0) +
    ...
    return setPembiayaan({
      ...
      bpp: inputDapem.bpp,
      pelunasan: inputDapem.pelunasan,
      by_tatalaksana: tempTatalaksana,
      by_mutasi: jenis.by_mutasi,
      by_provisi: tempProvisi,
      mg_bunga: produk.mg_bunga,
      by_admin: bank.by_admin,
      by_asuransi: produk.by_asuransi,
      ...
      tempat_lahir: tambahan.tempat_lahir,
      nama_bank: tambahan.nama_bank,
      no_rekening: tambahan.no_rekening,
      by_flagging: bank.by_flagging,
