...
export default function SIBprBNM({ data }: { data: DataDataPencairan }) {
  ...
  let tables = data.DataPengajuan.map((d, i) => {
    ...
    totalAngsuran += angs;
    totalPelunasan += d.DataPembiayaan.pelunasan;
    totalDropping +=
      d.DataPembiayaan.plafond -
      (newAdmin +
        rekening +
    ...
    return [
      ...
      {
        data: formatNumber(d.DataPembiayaan.pelunasan.toFixed(0)),
        width: 100,
      },
      {
        data: formatNumber(
          ...
          <Page size={"A4"} style={{ ...stylePdf.root, padding: 20 }}>
            ...
            <View style={{ marginTop: 50 }}>
              ...
              >
                ...
                >
                  <Text>{formatNumber(totalPelunasan.toFixed(0))}</Text>
                </View>
                <View
                  style={{
                    width: 100,
