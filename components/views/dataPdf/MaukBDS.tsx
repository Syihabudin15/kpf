...
export default function MaukBDS({ data }: { data: DataDataPengajuan }) {
            ...
            <View style={{ display: "flex", flexDirection: "row" }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  <View style={{ display: "flex", flexDirection: "row" }}>
                    <Text style={{ width: "40%" }}>Pendapatan/Gaji</Text>
                    <Text style={{ width: "10%" }}>:</Text>
                    <Text style={{ width: "50%" }}>
                      Rp.{" "}
                  ...
                  <View style={{ display: "flex", flexDirection: "row" }}>
                    <Text style={{ width: "40%" }}>Angsuran Perbulan</Text>
                    <Text style={{ width: "10%" }}>:</Text>
                    <Text style={{ width: "50%" }}>
                      Rp. {formatNumber(angsuranBulanan.toFixed(0))}
                    </Text>
                  </View>
                  {/* <View style={{ display: "flex", flexDirection: "row" }}>
                    <Text style={{ width: "40%" }}>
          ...
          >
            ...
            <View style={{ display: "flex", flexDirection: "row" }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ display: "flex", flexDirection: "row" }}>
                  <Text style={{ width: "40%" }}>Buka Rekening</Text>
                  <Text style={{ width: "10%" }}>:</Text>
                  <Text style={{ width: "50%" }}>
                    Rp.{" "}
                    {formatNumber(
                ...
                <View style={{ display: "flex", flexDirection: "row" }}>
                  <Text style={{ width: "40%" }}>Nominal Takeover</Text>
                  <Text style={{ width: "10%" }}>:</Text>
                  <Text style={{ width: "50%" }}>
                    Rp. {formatNumber(data.DataPembiayaan.pelunasan.toFixed(0))}{" "}
