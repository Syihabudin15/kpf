...
export default function CetakSuratBerkas({
  data,
}: {
  data: DataPenyerahanBerkas;
}) {
  let totalPlafond = 0;
        ...
        <Document title="Berkas SI">
          <Page size={"A4"} style={{ ...stylePdf.root, padding: 50 }}>
            ...
            <View style={{ marginTop: 30, lineHeight: 1.5 }}>
              <View style={{ display: "flex", flexDirection: "row", gap: 5 }}>
                ...
                <Text>{data.nomor_surat_berkas}</Text>
              </View>
              <View style={{ display: "flex", flexDirection: "row", gap: 5 }}>
              ...
              <View style={{ display: "flex", flexDirection: "row", gap: 5 }}>
                ...
                <Text style={{ fontWeight: "bold", width: 300 }}>
                  PENYERAHAN BERKAS PEMBIAYAAN{" "}
                  {new Date(data.tanggal_cetak as Date).toLocaleString(
                    "id-ID",
                    {
                      month: "long",
                    }
                  )}{" "}
                  {moment(data.tanggal_cetak).year()}
                </Text>
              </View>
            </View>
            <View style={{ marginTop: 30, lineHeight: 1.5 }}>
          ...
          <Page size={"A4"} style={{ ...stylePdf.root, padding: 50 }}>
            ...
            >
              <Text>Tanggal : </Text>
              <Text
                style={{ width: 30, borderBottom: "1px solid #aaa" }}
              ></Text>
            </View>
            <View
              style={{
