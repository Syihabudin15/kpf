...
const PengajuanPencairan = dynamic(
  () => import("@/components/views/operasionals/news/PengajuanPencairan"),
  {
    ssr: false,
...
export default async function page() {
  await handleRoute("/operasional/pencairan");
  ...
  return (
    <section className="rounded border shadow bg-white">
      ...
      >
        ...
        <p className="text-gray-300 text-xs">Data daftar pengajuan pencairan</p>
      </div>
      <PengajuanPencairan />
    </section>
  );
