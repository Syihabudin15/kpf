        ...
        const resultTaspen = await tx.dataTaspen.create({
          data: {
            ...
            jenis_hutang: data[i].JENISHUTANG
              ...
              : null,
            jumlah_kotor: data[i].JMLKOTOR ? data[i].JMLKOTOR.toString() : null,
            jumlah_potongan: data[i].JMLPOTONGAN
              ? data[i].JMLPOTONGAN.toString()
              : null,
            jumlah_total: data[i].JMLTOTAL ? data[i].JMLTOTAL.toString() : null,
            ...
            kantor_cabang: data[i].KANTOR_CABANG
              ...
              : null,
            jenis_dapem: data[i].JNSDAPEM ? data[i].JNSDAPEM.toString() : null,
            ...
            status_dapem: data[i].STSDAPEM ? data[i].STSDAPEM.toString() : null,
